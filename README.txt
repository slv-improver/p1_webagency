...
le site doit tenir sur une page avec 
    ──un menu qui reste visible, en haut de la page, même lorsque l'on se déplace dans la page── ;
...
Par ailleurs, j’aimerais également que tu rédiges 
    ──le texte de présentation de WebAgency.──
